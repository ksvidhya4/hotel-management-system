       ...
       <div class="row">
         <div class="col-md-12">
              <center><h3>Room Booking Page</h3></center>
                  ...
                  <div class="row">
                     <?php
                     $connection = mysqli_connect("localhost","root","vidhya123");
                    $db = mysqli_select_db($connection,"seaview_inn");
                     ...
                     while($row = mysqli_fetch_assoc($query_run)){
                       ?>
                       <table>
                 <tr>   <div class="col-md-2" style="margin-left:50px;">
               ...
               <a href="book_room.php?rn=<?php echo $row['room_no']."&rt=a"; ?>"  class="btn btn-primary <?php if($row['status']==0){echo "active";}else{echo "disabled";}?>">Book</a> &nbsp;
                <a href="unbook.php?rn=<?php  echo $row['room_no']."&rt=a";?>"  class="btn btn-danger <?php if($row['status']==0){echo "disabled";}else{echo "active";}?>">cancel</a>
</div>                      </tr>
</table>
                     </div>
                     </div>
               ...
               <a href="book_room.php?rn=<?php echo $row['room_no']."&rt=b"; ?>"  class="btn btn-primary <?php if($row['status']==0){echo "active";}else{echo "disabled";}?>">Book</a> &nbsp;
                          ...
                          <a href="unbook.php?rn=<?php  echo $row['room_no']."&rt=b";?>"  class="btn btn-danger <?php if($row['status']==0){echo "disabled";}else{echo "active";}?>">cancel</a>
</div>
                     </div>
                     </div>
                      <?php
               ...
               <p class="card-text">Room Status:<?php if($row['status']==0)
               {echo "<b>avaliable<b>";}else{echo "<b>Already booked<b>";}?></p>
               <a href="book_room.php?rn=<?php echo $row['room_no']."&rt=c"; ?>"
                 class="btn btn-primary <?php if($row['status']==0){echo "active";}else{echo "disabled";}?>">Book</a> &nbsp;

                  <a href="unbook.php?rn=<?php  echo $row['room_no']."&rt=c";?>"  class="btn btn-danger <?php if($row['status']==0){echo "disabled";}else{echo "active";}?>">cancel</a>
</div>
                     </div>
                     </div>
                      <?php
              ...
              <a href="book_room.php?rn=<?php echo $row['room_no']."&rt=d"; ?>"  class="btn btn-primary <?php if($row['status']==0){echo "active";}else{echo "disabled";}?>">Book</a> &nbsp;
                ...
                <a href="unbook.php?rn=<?php  echo $row['room_no']."&rt=d";?>"  class="btn btn-danger <?php if($row['status']==0){echo "disabled";}else{echo "active";}?>">cancel</a>
</div>
                     </div>
                     </div>
                      <?php
...
<!--============= start of footer area=========--->
      ...
      <h6 class="text-center bg-dark text-white p-3">designed and developed by aditi and vidhya</h6>
